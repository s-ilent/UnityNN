...
namespace Marathon.Formats.Mesh.Ninja
{
    ...
    public class NinjaObject
    {
        ...
        public List<NinjaMaterial> Materials { get; set; } = new List<NinjaMaterial>();

        public List<NinjaMaterialColours> MaterialColours { get; set; } = new List<NinjaMaterialColours>();

        public List<NinjaMaterialLogic> MaterialLogics { get; set; } = new List<NinjaMaterialLogic>();

        public List<NinjaTextureMap> TextureMaps { get; set; } = new List<NinjaTextureMap>();

        public List<NinjaVertexList> VertexLists { get; set; } = new List<NinjaVertexList>();

        public List<NinjaPrimitiveList> PrimitiveLists { get; set; } = new List<NinjaPrimitiveList>();

        public uint MaxNodeDepth { get; set; }

        public List<NinjaNode> Nodes { get; set; } = new List<NinjaNode>();

        public uint MatrixIndexCount { get; set; }

        public List<NinjaSubObject> SubObjects { get; set; } = new List<NinjaSubObject>();
        ...
        public void Read(BinaryReaderEx reader)
        {
            ...
            for (int i = 0; i < MaterialsCount; i++)
            {
                ...
                NinjaMaterial Material = new NinjaMaterial();
            ...
            {
                reader.JumpTo(MaterialsOffset + (i * 8), true);
                NinjaMaterialColours MaterialColours = new NinjaMaterialColours();
            ...
            {
                reader.JumpTo(MaterialsOffset + (i * 8), true);
                NinjaMaterialLogic MaterialLogic = new NinjaMaterialLogic();
            ...
            {
                reader.JumpTo(MaterialsOffset + (i * 8), true);
                NinjaTextureMap TextureMap = new NinjaTextureMap();
            ...
            for (int i = 0; i < VertexListCount; i++)
            {
                ...
                NinjaVertexList VertexList = new NinjaVertexList();
            ...
            for (int i = 0; i < PrimitiveListCount; i++)
            {
                ...
                NinjaPrimitiveList Primitive = new NinjaPrimitiveList();
            ...
            for (int i = 0; i < SubObjectCount; i++)
            {
                ...
                NinjaSubObject SubObject = new NinjaSubObject();
...
/*
        ...
        public void Write(BinaryWriterEx writer)
        {
            ...
            Dictionary<string, uint> ObjectOffsets = new Dictionary<string, uint>();
