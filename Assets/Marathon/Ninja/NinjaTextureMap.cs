...
namespace Marathon.Formats.Mesh.Ninja
{
    ...
    {
        public List<NinjaMaterialTextureMapDescription> NinjaTextureMapDescriptions { get; set; } = new List<NinjaMaterialTextureMapDescription>();
        ...
        public void Read(BinaryReaderEx reader)
        {
            ...
            {
                NinjaMaterialTextureMapDescription TexMapDesc = new NinjaMaterialTextureMapDescription()
                {
