...
namespace Marathon.Formats.Mesh.Ninja
{
    ...
    public class NinjaEffectList
    {
        ...
        public List<NinjaEffectFile> NinjaEffectFiles { get; set; } = new List<NinjaEffectFile>();

        public List<NinjaTechniqueName> NinjaTechniqueNames { get; set; } = new List<NinjaTechniqueName>();

        public List<short> NinjaTechniqueIndices { get; set; } = new List<short>();
        ...
        public void Read(BinaryReaderEx reader)
        {
            ...
            for (int i = 0; i < TechniqueNamesCount; i++)
            {
                ...
                NinjaTechniqueName TechniqueName = new NinjaTechniqueName();
